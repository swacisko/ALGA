...
//            cerr << neigh[i].first << "->" << neigh[i].second << endl;
    ...
    static void writeNodeTreeWithNeighbors( int id ){
        ...
        sort( neigh.begin(), neigh.end(), [](auto &&a, auto &&b){ if( a.second != b.second ) return a.second < b.second; else return a.first < b.first; } );
...
//        cerr << neigh[0].first << endl;
        ...
        for( int i=0; i<neigh.size(); i++ ){
            ...
            sort( neigh2.begin(), neigh2.end(), [](auto &&a, auto &&b){ if( a.second != b.second ) return a.second < b.second; else return a.first < b.first; } );
