...
public:
    ...
    void setAlignFrom(int from, bool val) override { alignFrom[from] = val; graphCreator->setAlignFrom(from,val); }
    void setAlignTo(int to, bool val) override { alignTo[to] = val; graphCreator->setAlignTo(to,val); }
protected:
